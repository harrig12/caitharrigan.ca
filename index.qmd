...
::: {.g-col-sm-2 .g-col-md-1}
<a href="mailto:charrigan(at)cs.toronto.edu" class="btn btn-outline-primary" role="button" aria-label="email"><i class="fa-solid fa-envelope"></i></a>
:::
...
`r cv_entries %>% filter(grepl("publication", type)) %>% mutate(when = NA) %>% print_section() %>% gsub(pattern = 'Caitlin F. Harrigan', replacement = '**Caitlin F. Harrigan**')`
